            ...
            <div
              ...
              className={cn(
                ...
                isActive
                  ...
                  : 'bg-white text-slate-700 border-slate-200 hover:bg-slate-50 hover:text-slate-900 dark:bg-card dark:text-muted-foreground dark:border-border dark:hover:bg-secondary dark:hover:text-foreground'
              )}
            >
              <span>{t.label}</span>
