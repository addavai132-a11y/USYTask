          ...
          return (
            <button
              ...
              className={cn(
                ...
                active
                  ? 'bg-emerald-700 text-white border-emerald-700 shadow-sm dark:bg-purple-600/25 dark:text-purple-200 dark:border-purple-500/50 dark:shadow-[0_0_16px_rgba(168,85,247,0.25)] backdrop-blur-md'
...
export function FloatingAddButton() {
  ...
  return (
    <button
      ...
      aria-label="Añadir"
      className="safe-bottom fixed bottom-20 right-4 z-40 flex size-14 items-center justify-center rounded-full bg-emerald-700 hover:bg-emerald-800 text-white shadow-lg shadow-emerald-950/20 dark:bg-gradient-to-r dark:from-purple-600 dark:to-indigo-600 dark:shadow-purple-950/80 border border-emerald-600/30 dark:border-purple-400/30 transition-transform active:scale-90 lg:bottom-8 lg:right-8"
    >
...
export function Sidebar() {
  ...
  return (
    <aside className="sticky top-0 hidden h-screen w-64 shrink-0 flex-col border-r border-slate-200/80 dark:border-purple-500/15 bg-white dark:bg-[#090814]/85 backdrop-blur-2xl px-4 py-6 lg:flex">
      ...
      <button
        onClick={openQuickAdd}
        className="mt-6 flex items-center justify-center gap-2 rounded-2xl bg-emerald-700 hover:bg-emerald-800 text-white dark:bg-gradient-to-r dark:from-purple-600 dark:to-indigo-600 dark:hover:from-purple-500 dark:hover:to-indigo-500 py-3 font-semibold shadow-md shadow-emerald-900/10 dark:shadow-purple-950/60 border border-emerald-600/30 dark:border-purple-400/30 transition-all active:scale-95"
      >
          ...
          return (
            <button
              ...
              className={cn(
                ...
                active
                  ? 'bg-emerald-700 text-white border-emerald-700 shadow-sm dark:bg-purple-600/25 dark:text-purple-200 dark:border-purple-500/50 dark:shadow-[0_0_16px_rgba(168,85,247,0.2)] backdrop-blur-md'
                  : 'border-transparent text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-purple-500/10 hover:text-slate-900 dark:hover:text-white'
              )}
            >
            ...
            <div className="relative inline-flex h-5 w-9 shrink-0 cursor-pointer items-center rounded-full bg-slate-300 dark:bg-purple-950/80 p-0.5 transition-colors">
              <span
                className={cn(
                  ...
                  mode === 'dark' ? 'translate-x-4 bg-purple-400' : 'translate-x-0 bg-emerald-700'
                )}
              />
            </div>
          </button>
